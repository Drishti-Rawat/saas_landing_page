...
{faq.question}
            ...
            <div className={clsx("faq-icon relative flex size-12 items-center justify-center rounded-full bottom-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4",active && 'before:bg-p1 after:rotate-0 after:bg-p1')}>
        ...
        <SlideDown>
                {
                    activeId===faq.id && <div className='body-3 px-7 py-3.5 ' >
                        {faq.answer}
                    </div>
                }
            </SlideDown>
