'use client'
import { details, features } from '@/contents'
                            ...
                            <div key={id} className='relative z-2 md:px-10 px-5 md:pb-10  pb-5 flex-50 max-md:g7  max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320'>
                             <div className='w-full flex justify-start items-start'> 
                                <div className='-ml-3 mb-12 flex flex-col items-center justify-center'>
                                    ...
                                    <img src={icon} alt="featres icosn"  className='size-28 object-contain'/>
                             ...
                             <p className=' max-w-400 mb-7 h3 text-p4  max-md:mb-6  max-md:h5'>
                                {title}
                             </p>
            ...
            <li key={id} className='relative pt-16 px-4 pb-14'>
                <div className='absolute top-8 bottom-0 
                 ...
                 <div className='flex  items-center justify-center mx-auto mb-3 border-2 border-s2 rounded-full hover:border-s4  transition-all duration-500 shadow-500 size-20 '>
                    <img src={icon} className='size-17/20 object-contain z-10' alt="icons" />
                 </div>
                 <h3 className='relative z-2 max-2-36 mx-auto my-0 base-small text-center uppercase '>{title}</h3>
            </li>
        ))
    }
